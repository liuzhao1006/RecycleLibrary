...
public class LzRefreshViewFooter extends LinearLayout implements IFooterCallBack {
    ...
    public LzRefreshViewFooter(Context context) {
        super(context);
        initView(context);
    }

    public LzRefreshViewFooter(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView(context);
    }

    @Override
    public void callWhenNotAutoLoadMore(final LzRefreshView xRefreshView) {
...
//        setVisibility(show?VISIBLE:GONE);
    ...
    private void initView(Context context) {
        mContext = context;
        ViewGroup moreView = (ViewGroup) LayoutInflater.from(mContext).inflate(R.layout.lz_footer, this);
