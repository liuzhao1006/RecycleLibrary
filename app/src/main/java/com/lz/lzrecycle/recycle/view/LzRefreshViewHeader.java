...
public class LzRefreshViewHeader extends LinearLayout implements IHeaderCallBack {
    ...
    public LzRefreshViewHeader(Context context) {
        super(context);
        initView(context);
    }
     ...
     * @param attrs
     */
    public LzRefreshViewHeader(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView(context);
    }
