...
public class LzScrollView extends ScrollView {
    ...
    private Runnable mRunnable = new Runnable() {
        ...
        public void run() {
            if (lastT == getScrollY() && !inTouch) {
                ...
                onScrollListener.onScrollStateChanged(LzScrollView.this, OnScrollListener.SCROLL_STATE_IDLE, isBottom());
                if (mScrollListener != null) {
                    mScrollListener.onScrollStateChanged(LzScrollView.this, OnScrollListener.SCROLL_STATE_IDLE, isBottom());
                }
            }
        }
    };
    ...
    protected void setOnScrollListener(LzRefreshView parent, OnScrollListener scrollListener) {
        mParent = parent;
        this.onScrollListener = scrollListener;
        mParent.addTouchLifeCycle(new LzRefreshView.TouchLifeCycle() {
            @Override
